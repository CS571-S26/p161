      ...
      {transactions.length === 0 ? (
        <div className="card shadow-sm">
          <div className="card-body">
            <p className="text-body-secondary mb-0">Add transactions to see spending reports.</p>
          </div>
        </div>
      ) : (
        <>
          <div className="row g-4 mb-4">
            ...
            <div className="col-md-3">
              <div className="card shadow-sm h-100">
                <div className="card-body">
                  <p className="card-title fw-semibold mb-2">Average Transaction</p>
            ...
            <div className="col-md-3">
              <div className="card shadow-sm h-100">
                <div className="card-body">
                  <p className="card-title fw-semibold mb-2">Largest Expense</p>
            ...
            <div className="col-md-3">
              <div className="card shadow-sm h-100">
                <div className="card-body">
                  <p className="card-title fw-semibold mb-2">Most Frequently Used Category</p>
          ...
          <div className="card shadow-sm mb-4">
            <div className="card-body">
              <h2 className="h4 card-title">Category Analysis</h2>
          ...
          <div className="row g-4 mb-4">
            <div className="col-md-6">
              <div className="card shadow-sm h-100">
                <div className="card-body">
                  <h2 className="h4 card-title">Transaction Patterns</h2>
                  <p className="mb-2">
            ...
            <div className="col-md-6">
              <div className="card shadow-sm h-100">
                <div className="card-body">
                  <h2 className="h4 card-title">Insights</h2>
                  <p className="mb-2">
